...
Work only within the parent task's approved scope and shared budget. A supplied direction or decision card can record a delegated choice; never represent it as user approval, widen it, or replace it with your own direction.
